				...
				init: function(selector) {
					...
					__core.isFuncTrue( function() {
						...
						selector.forEach( function(element) {
							...
							var elDirection = element.getAttribute('data-direction') || 'vertical',
								elSpeed = element.getAttribute('data-speed') || 500,
								elAutoPlay = element.getAttribute('data-autoplay') || true,
								...
								elEffect = element.getAttribute('data-effect') || 'coverflow',
